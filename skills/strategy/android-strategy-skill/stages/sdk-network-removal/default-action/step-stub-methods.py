#!/usr/bin/env python3
"""android sdk-network-removal step 08 stub-methods: 调用 common 脚本.

android 子阶段 sdk-network-removal default-action。
调用 android 该子阶段的 common 脚本: skills/common/general-strategy-skill/scripts/workflow/sub-stage-sdk-network-removal.py。
"""
...
class StubMethodsStep(Step):
    def execute(self, steps_results: dict) -> dict:
        ...
        return {
            ...
            "skipped": False,
            "common_script": "skills/common/general-strategy-skill/scripts/workflow/sub-stage-sdk-network-removal.py",
