#!/usr/bin/env python3
"""android preprocess-build step 7 gradle-build: 调用 common 脚本.

android 子阶段 preprocess-build default-action。
调用 android 该子阶段的 common 脚本: skills/common/general-strategy-skill/scripts/workflow/sub-stage-preprocess-build.py。
"""
...
class GradleBuildStep(Step):
    def execute(self, steps_results: dict) -> dict:
        ...
        return {
            ...
            "skipped": False,
            "common_script": "skills/common/general-strategy-skill/scripts/workflow/sub-stage-preprocess-build.py",
