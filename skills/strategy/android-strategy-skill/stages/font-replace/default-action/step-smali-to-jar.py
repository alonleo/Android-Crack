#!/usr/bin/env python3
"""android font-replace step 1 smali-to-jar: 调用 common 脚本.

android 子阶段 font-replace default-action。
调用 android 该子阶段的 common 脚本: skills/common/general-strategy-skill/scripts/workflow/sub-stage-font-replace.py。
"""
...
class SmaliToJarStep(Step):
    def execute(self, steps_results: dict) -> dict:
        ...
        return {
            ...
            "skipped": False,
            "common_script": "skills/common/general-strategy-skill/scripts/workflow/sub-stage-font-replace.py",
