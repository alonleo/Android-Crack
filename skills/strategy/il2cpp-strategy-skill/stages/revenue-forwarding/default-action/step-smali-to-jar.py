...
05-revenue-forwarding/build action。
smali→jar 已由 asbuilder-dex-jarify 完成（游戏 dex → app/libs/classes.N.dex.jar）。
[FLOWFIX] ASBuilder 契约：查 libs/*.jar（兼兼容 javaScaffoding）。
"""
