# Xamarin Strategy — Workflow

> 本文件是 xamarin-strategy-skill 的**流程操作手册**。
>
...
实现要点见 [去功能点：xamarin](../../common/feature-removal-strategy-skill/references/engine-notes.md#xamarin)；步骤、产物与验收见 [统一阶段接口](../../common/feature-removal-strategy-skill/references/stage-contract.md)。
