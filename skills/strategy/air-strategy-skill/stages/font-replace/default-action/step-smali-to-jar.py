#!/usr/bin/env python3
"""air font-replace step 1 smali-to-jar: 调用脚本.

air 子阶段 font-replace default-action。
调用该 type 该子阶段的脚本: skills/strategy/air-strategy-skill/scripts/workflow/sub-stage-air-fonts.py。
"""
...
class SmaliToJarStep(Step):
    def execute(self, steps_results: dict) -> dict:
        ...
        script = REPO / "skills/strategy/air-strategy-skill/scripts/workflow/sub-stage-air-fonts.py"
        ...
        return {
            ...
            "skipped": False,
            "script": "skills/strategy/air-strategy-skill/scripts/workflow/sub-stage-air-fonts.py",
