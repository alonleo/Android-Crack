#!/usr/bin/env python3
"""air static-analyze step 2 gen-findings: 调用脚本.

air 子阶段 static-analyze default-action。
调用该 type 该子阶段的脚本: skills/strategy/air-strategy-skill/scripts/workflow/sub-stage-air-static-analyze.py。
"""
...
class GenFindingsStep(Step):
    def execute(self, steps_results: dict) -> dict:
        ...
        script = REPO / "skills/strategy/air-strategy-skill/scripts/workflow/sub-stage-air-static-analyze.py"
        ...
        return {
            ...
            "skipped": False,
            "script": "skills/strategy/air-strategy-skill/scripts/workflow/sub-stage-air-static-analyze.py",
